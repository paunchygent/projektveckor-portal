...
TEMPLATES: dict[str, TaskTemplate] = {
    ...
    "epic": TaskTemplate(
        ...
        checklist=("Stories linked", "Acceptance criteria defined", "Execution gate defined"),
    ...
    "task": TaskTemplate(
        status="proposed",
        sections=("Objective", "PR Scope", "Deliverables", "Acceptance Criteria", "Checklist"),
        checklist=("Implementation complete", "Validation complete", "Docs updated"),
    ...
    "task-log": TaskTemplate(
        status="active",
        sections=("Context", "Worklog", "Next Actions"),
        checklist=(),
